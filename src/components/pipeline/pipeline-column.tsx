...
export function PipelineColumn({ stage, leads, onLeadAdded }: { stage: PipelineStage, leads: Lead[], onLeadAdded: (newLead: Lead) => void }) {
    ...
    return (
        <div className="flex-1 min-w-[300px] flex flex-col">
            <div className={`bg-muted/50 rounded-lg p-4 pt-3 flex flex-col flex-1 transition-colors ${isOver ? 'bg-accent/20' : ''}`}>
                ...
                <AddLeadDialog onLeadAdded={onLeadAdded} defaultStatus={stage.name}>
